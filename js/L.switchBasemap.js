L.Control.basemapsSwitcher = L.Control.extend({
    ...
    onAdd: function (map){
        var container = this.container = L.DomUtil.create('div', 'leaflet-control-basemapsSwitcher');
    ...
    _createItems() {
        this.layers.forEach( (obj, index) => {
            ...
            var imgContainer = L.DomUtil.create('div', 'basemapImg');
            var img = L.DomUtil.create('div');
            var name = L.DomUtil.create('div', 'name');
            var check = L.DomUtil.create('div', 'check');
